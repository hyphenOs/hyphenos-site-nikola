...
BLOG_AUTHOR = "hyphenOs"  # (translatable)
BLOG_TITLE = "hyphenOs"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hyphenos.io/"
BLOG_EMAIL = "mail@hyphenos.io"
BLOG_DESCRIPTION = "Software Development Swiss Army Knife"  # (translatable)
...
LOGO_URL = '/assets/img/hyphenos-logo-is-text-light.png'
...
IMAGE_FOLDERS = {'images/blogs': 'blog/images'}
...
# (translatable)
CONTENT_FOOTER = '&copy; Copyright {date} '
...
GLOBAL_CONTEXT = {
        ...
        'BANNER_URL': "/assets/img/goran-ivos-ly-1982x1982-unsplash.jpg"
}
